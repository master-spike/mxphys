...
public:
    ...
    void apply_impulses(double delta, std::function<mxphys::body*(uint64_t)> get_body_from_id) const {
        ...
        vec2 impulse = ((p2 - p1).normalized()) * extension * delta;
